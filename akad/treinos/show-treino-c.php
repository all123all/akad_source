...
$query_get_id_treino = mysqli_query($link, 'SELECT id_treino_c FROM aluno_dados WHERE id = ' . $aluno_matricula);
$row = mysqli_fetch_assoc($query_get_id_treino);
$bd_id_treino_a = $row['id_treino_c'];
...
<body>
    <div align="center">
        ...
        <table id="aluno_treino">
            ...
            <tr>
                <td><?php
                    $query_get_rep = mysqli_query($link, 'SELECT rep' . $i . ' FROM aluno_treino_c WHERE id_aluno = ' . $aluno_matricula);
                ...
                <td><?php
                    $query_get_serie = mysqli_query($link, 'SELECT rep' . $i . '_serie FROM aluno_treino_c WHERE id_aluno = ' . $aluno_matricula);
                    $row = mysqli_fetch_assoc($query_get_serie);
                    $bd_serie = $row['rep' . $i . '_serie'];
                    echo $bd_serie;
                ?></td>
                <td><?php
                    $query_get_obs = mysqli_query($link, 'SELECT rep' . $i . '_obs FROM aluno_treino_c WHERE id_aluno = ' . $aluno_matricula);
