...
$query_get_id_treino = mysqli_query($link, 'SELECT id_treino_a FROM aluno_dados WHERE id = ' . $aluno_matricula);
$row = mysqli_fetch_assoc($query_get_id_treino);
$bd_id_treino_a = $row['id_treino_a'];
...
<body>
    <div align="center">
        ...
        <p>Aluno: <?php echo $aluno_nome; ?></p>
        <p>Matrícula: <?php echo $aluno_matricula; ?></p>
        <p>Treino: A</p>
        ...
        <table id="aluno_treino">
            ...
            <tr>
                <td><?php
                    $query_get_rep = mysqli_query($link, 'SELECT rep' . $i . ' FROM aluno_treino_a WHERE id_aluno = ' . $aluno_matricula);
                ...
                <td><?php
                    $query_get_serie = mysqli_query($link, 'SELECT rep' . $i . '_serie FROM aluno_treino_a WHERE id_aluno = ' . $aluno_matricula);
                    $row = mysqli_fetch_assoc($query_get_serie);
                    $bd_serie = $row['rep' . $i . '_serie'];
                    echo $bd_serie;
                ?></td>
                <td><?php
                    $query_get_obs = mysqli_query($link, 'SELECT rep' . $i . '_obs FROM aluno_treino_a WHERE id_aluno = ' . $aluno_matricula);
        ...
        <p>Data da próxima avaliação física: dd/mm/aa</p>
