...
--
-- Host: localhost
-- Tempo de geração: 09/07/2018 às 21:20
...
--
-- Banco de dados: `akad_test`
--
CREATE DATABASE IF NOT EXISTS `akad_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `akad_test`;

-- --------------------------------------------------------

--
-- Estrutura para tabela `aluno_dados`
--

CREATE TABLE `aluno_dados` (
  `id` int(11) NOT NULL,
...
--
-- Fazendo dump de dados para tabela `aluno_dados`
--

INSERT INTO `aluno_dados` (`id`, `nome`, `cpf`, `nascimento`, `email`, `endereco`, `telefone`, `foto_link`) VALUES
(9, 'Luiz Alves da Silva Neto', '112.384.894-78', '2000-12-19', 'luizvau@gmai.com', 'R 38 N 55', '81-99349-4650', ''),
(10, 'Allyson Henrique', '9935713985', '2018-07-03', 'fmaief@gmail.com', 'err 23 fe ef ', '31151351351351', ''),
(11, 'Karalho', '3151513', '2018-07-04', 'aefaefa@mail.co', 'R Elias F Santos NÂº55', '31151351351351', ''),
(12, 'aefaefae qe fqe qe q eq q', '093607244-08', '2018-07-09', 'allyson2308h2@gmail.com', 'efaeff qef q', '31151351351351', '');

-- --------------------------------------------------------

--
-- Estrutura para tabela `caixa_fluxo`
--

CREATE TABLE `caixa_fluxo` (
  `id` int(11) NOT NULL,
  `caixa_nome` varchar(255) NOT NULL,
  `data_abertura` date NOT NULL,
  `data_fechamento` date NOT NULL,
  `valor_informado` double NOT NULL,
...
--
-- Estrutura para tabela `funcionario_dados`
--
...
--
-- Estrutura para tabela `produto_dados`
--
...
--
-- Índices de tabela `aluno_dados`
--
ALTER TABLE `aluno_dados`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `caixa_fluxo`
--
ALTER TABLE `caixa_fluxo`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `funcionario_dados`
--
ALTER TABLE `funcionario_dados`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `produto_dados`
--
ALTER TABLE `produto_dados`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `aluno_dados`
--
ALTER TABLE `aluno_dados`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de tabela `caixa_fluxo`
--
ALTER TABLE `caixa_fluxo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `funcionario_dados`
--
ALTER TABLE `funcionario_dados`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `produto_dados`
--
ALTER TABLE `produto_dados`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- Fazendo dump de dados para tabela `fornecedores_contatos`
--
...
--
-- Fazendo dump de dados para tabela `franquias`
--
...
--
-- Fazendo dump de dados para tabela `pedidos_item`
--
...
--
-- Fazendo dump de dados para tabela `pedidos_status`
--
...
--
ALTER TABLE `clientes`
  MODIFY `clienteID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
(19, 'Luiz Alves', 'luizvau@gmail.com'),
(20, 'Ana Claudia da Silva Marques', 'claudia210775@gmail.com'),
(17, 'Allyson Henrique', 'allyson2308h@gmail.com');
...
('root', '2018-07-09 19:17:49', '{\"lang\":\"pt_BR\",\"Console\\/Mode\":\"collapse\"}');
